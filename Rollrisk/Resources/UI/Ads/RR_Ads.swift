...
public class RR_Ads : NSObject {
	
	public static let shared:RR_Ads = .init()
...
extension RR_Ads : FullScreenContentDelegate {
...
extension RR_Ads : BannerViewDelegate {
...
extension BannerView {
	...
	open override func didMoveToSuperview() {
		...
		NotificationCenter.add(.updateAds) { [weak self] _ in
			...
			self?.isHidden = !RR_Ads.shared.shouldDisplayAd
			self?.refresh()
		}
	}
