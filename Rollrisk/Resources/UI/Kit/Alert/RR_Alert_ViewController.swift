...
public class RR_Alert_ViewController : UIViewController {
	...
	public lazy var titleLabel:RR_Label = {
	...
	@discardableResult public static func present(_ error:Error, handler:(()->Void)? = nil) -> RR_Alert_ViewController {
		
		RR_Feedback.shared.make(.Error)
		
		let viewController:RR_Alert_ViewController = .init()
	...
	public static func presentLoading(_ completion:((RR_Alert_ViewController?)->Void)? = nil) {
	...
	@discardableResult public func add(_ string:String?) -> RR_Label {
		
		let label:RR_Label = .init(string)
	...
	@discardableResult public func addButton(sticky:Bool = false, title:String, subtitle:String? = nil,image:UIImage? = nil, _ handler:RR_Button.Handler = nil) -> RR_Button {
		
		let button:RR_Button = .init(title,handler)
	...
	@discardableResult public func addCancelButton(sticky:Bool = false, _ handler:RR_Button.Handler = nil) -> RR_Button {
		
		let button:RR_Button = addButton(sticky:sticky, title: String(key: "alert.cancel.button")) { [weak self] button in
	...
	@discardableResult public func addDismissButton(sticky:Bool = false, _ handler:RR_Button.Handler = nil) -> RR_Button {
		
		let button:RR_Button = addButton(sticky:sticky, title: String(key: "alert.dismiss.button")) { [weak self] button in
...
extension RR_Alert_ViewController : UIScrollViewDelegate {
...
extension RR_Alert_ViewController : UIPopoverPresentationControllerDelegate {
