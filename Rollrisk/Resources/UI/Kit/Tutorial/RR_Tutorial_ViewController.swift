//
//  RR_Tutorial_ViewController.swift
//  LettroLine
//
...
public class RR_Tutorial_ViewController: RR_ViewController {
	...
	private lazy var titleLabel: RR_Label = {
	...
	public lazy var subtitleLabel: RR_Label = {
	...
	private lazy var nextButton: RR_Button = .init() { [weak self] _ in
