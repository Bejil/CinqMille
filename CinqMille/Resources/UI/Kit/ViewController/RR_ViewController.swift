...
public class CM_ViewController: UIViewController {
	...
	public override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
		...
		let lineColor = Colors.Content.Text.withAlphaComponent(0.05)
		let cometColor = Colors.Content.Text.withAlphaComponent(0.1)
