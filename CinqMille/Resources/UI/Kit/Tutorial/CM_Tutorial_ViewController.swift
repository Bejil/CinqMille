//
//  CM_Tutorial_ViewController.swift
//  LettroLine
//
...
public class CM_Tutorial_ViewController: CM_ViewController {
	...
	private lazy var titleLabel: CM_Label = {
	...
	public lazy var subtitleLabel: CM_Label = {
	...
	private lazy var nextButton: CM_Button = .init() { [weak self] _ in
