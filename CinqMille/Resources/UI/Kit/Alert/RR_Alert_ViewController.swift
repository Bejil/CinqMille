...
public class CM_Alert_ViewController : UIViewController {
	...
	public lazy var titleLabel:CM_Label = {
	...
	@discardableResult public static func present(_ error:Error, handler:(()->Void)? = nil) -> CM_Alert_ViewController {
		
		CM_Feedback.shared.make(.Error)
		
		let viewController:CM_Alert_ViewController = .init()
	...
	public static func presentLoading(_ completion:((CM_Alert_ViewController?)->Void)? = nil) {
	...
	@discardableResult public func add(_ string:String?) -> CM_Label {
		
		let label:CM_Label = .init(string)
	...
	@discardableResult public func addButton(sticky:Bool = false, title:String, subtitle:String? = nil,image:UIImage? = nil, _ handler:CM_Button.Handler = nil) -> CM_Button {
		
		let button:CM_Button = .init(title,handler)
	...
	@discardableResult public func addCancelButton(sticky:Bool = false, _ handler:CM_Button.Handler = nil) -> CM_Button {
		
		let button:CM_Button = addButton(sticky:sticky, title: String(key: "alert.cancel.button")) { [weak self] button in
	...
	@discardableResult public func addDismissButton(sticky:Bool = false, _ handler:CM_Button.Handler = nil) -> CM_Button {
		
		let button:CM_Button = addButton(sticky:sticky, title: String(key: "alert.dismiss.button")) { [weak self] button in
...
extension CM_Alert_ViewController : UIScrollViewDelegate {
...
extension CM_Alert_ViewController : UIPopoverPresentationControllerDelegate {
