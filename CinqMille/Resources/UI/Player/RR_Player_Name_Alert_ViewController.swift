//
//  CM_Player_Name_Alert_ViewController.swift
//  CinqMille
//
...
public class CM_Player_Name_Alert_ViewController : CM_Alert_ViewController {
	
	public var completion:(()->Void)?
	private lazy var textField:CM_TextField = {
	...
	public override func present(as style: CM_Alert_ViewController.Style = .Alert, withAnimation animated: Bool = true, _ completion: (() -> Void)? = nil) {
