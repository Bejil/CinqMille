...
public class CM_Rules_ViewController : CM_ViewController {
	
	private let rules = CM_Rules.shared
	...
	private func section(with title:String, and content:String) -> UIStackView {
		...
		let contentLabel:CM_Label = .init(content)
