...
public class CM_Dices_ViewController : CM_Game_ViewController {
	...
	public override func viewWillAppear(_ animated: Bool) {
		...
		// Appeler directement la logique de base de CM_ViewController
